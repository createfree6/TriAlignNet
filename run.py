...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='TriAlignNet')
    ...
    parser.add_argument('--model', type=str, required=True, default='TriAlignNet',
                        help='model name, options: [Autoformer, Transformer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, required=True, default='ETTm1', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='Environment.csv', help='data file')
    ...
    parser.add_argument('--text_emb', type=int, default=12, help='prediction sequence length')
    ...
    parser.add_argument('--prior_weight', type=float, default=0, help='prompt weight')#please tune this hyperparameter for combining
    ...
    parser.add_argument('--huggingface_token', type=str, default='XXXXXXXX', help='your token of huggingface;need for llama3')
